...
LDFLAGS="-s -w \
-X github.com/ebogdum/keramos/v2/internal/cli.Version=${VERSION} \
-X github.com/ebogdum/keramos/v2/internal/cli.Commit=${COMMIT} \
-X github.com/ebogdum/keramos/v2/internal/cli.BuildDate=${BUILD_DATE}"
